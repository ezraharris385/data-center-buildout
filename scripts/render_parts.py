...
PARTS += [
    ...
    P('MEC-005','V-coil bank left','vpanel', 0,1450,-620, 11700,80,1950, rx=-26, mat='coilSilver',
      notes='Microchannel coil, ~26 deg from vertical, full length'),
    P('MEC-005','V-coil bank right','vpanel', 0,1450,620, 11700,80,1950, rx=26, mat='coilSilver'),
    P('MEC-005','End panel A','box', -5960,1500,0, 80,2275,2000, mat='casing'),
    P('MEC-005','End panel B','box', 5960,1500,0, 80,2275,2000, mat='casing'),
    P('MEC-005','V end closure A','box', -5850,2100,0, 100,2100,700, mat='casing'),
    P('MEC-005','V end closure B','box', 5850,2100,0, 100,2100,700, mat='casing'),
    P('MEC-005','Fan deck','box', 0,2480,0, 12000,2100,70, mat='casing'),
    ...
    P('MEC-005','Lower plenum panel A','box', 0,650,-1090, 11800,60,1100, mat='casing'),
    P('MEC-005','Lower plenum panel B','box', 0,650,1090, 11800,60,1100, mat='casing'),
...
PARTS += [
    ...
    P('MEC-001','V-coil left','vpanel', -1800,1300,-560, 8200,70,1750, rx=-30, mat='coilSilver',
      notes='Condenser coils occupy ~8.2 m of length; compressor end clear'),
    P('MEC-001','V-coil right','vpanel', -1800,1300,560, 8200,70,1750, rx=30, mat='coilSilver'),
    P('MEC-001','V end closure A','box', -5850,1950,0, 100,900,700, mat='casing'),
    P('MEC-001','V end closure B','box', 2250,1950,0, 100,900,700, mat='casing'),
    ...
    P('MEC-001','Lower plenum panel A','box', -1800,600,-1080, 8300,60,950, mat='casing'),
    P('MEC-001','Lower plenum panel B','box', -1800,600,1080, 8300,60,950, mat='casing'),
...
PARTS += [
    ...
    P('MEC-002','Body shell','box', 0,1150,0, 10700,2250,1950, mat='casing'),
    P('MEC-002','Louver band left','box', 0,1150,-1140, 10500,50,1700, mat='coilSilver'),
    P('MEC-002','Louver band right','box', 0,1150,1140, 10500,50,1700, mat='coilSilver'),
