...
export const mats = {
  ...
  wallGlass: () => std('wallGlass', { color: 0x9fd8ff, roughness: 0.1, metalness: 0.6, transparent: true, opacity: 0.055, side: THREE.DoubleSide, depthWrite: false }),
  roof: () => std('roof', { color: 0x878e96, roughness: 0.75, metalness: 0.2 }),  // TPO membrane gray-white
